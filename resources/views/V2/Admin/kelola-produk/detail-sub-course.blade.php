...
<div class="container-fluid" id="container-wrapper">
    ...
    <a href="allproduct.html">
        ...
        {{ $name }} <span style="font-weight: 100;"></span>
        </p>
    </a>
    </div>
    ...
    <div class="col-12" style="top: -3vh;">
        <div class="tambah" style="float: right;">
            <a href="{{route('file.kelola',$babCourse->course_id)}}" class="btn btn-5" style="background: #FF9F1C; color: black;">Kelola File</a>
            <a href="{{route('subCourse.create',$babCourse->id)}}" class="btn btn-5">Tambah Course</a>
        </div>
    </div>
    <!-- <div class="col-lg-12"> -->
    <div class="col-12 col-md-12 col-lg-12" style="margin-top: 5vh;">
        ...
        <table id="table_id" class="display table table-dark" style="background: #252633;">
            ...
            <tr>
                ...
                <button data-toggle="modal" data-target="#preview-course{{$ce->id}}" class="btn btn-4" role="button">Demo</button>
                <a href="{{route('subCourse.edit',['id'=>$ce->id])}}" class="btn btn-5" role="button">Edit</a>
            ...
            <!-- Modal Demo -->
            <div class="modal fade" id="preview-course{{$ce->id}}" tabindex="-1" role="dialog" aria-labelledby="preview-course" aria-hidden="true">
