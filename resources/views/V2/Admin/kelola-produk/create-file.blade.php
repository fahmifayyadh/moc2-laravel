    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <a href="allproduct.html"  >
        <p style="color:white;font-family: 'Rubik', sans-serif; font-weight: 600; font-size: 30px;">
          ...
          CREATE FILE <span style="font-weight: 100;"></span>
        </p>
      </a>
    </div>
        ...
        <div class="col-12 col-md-6 col-lg-6">
          <form action="{{route('file.create', $course->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input type="text" required placeholder="Nama File" name="nama" data-original-title="" title="" class="form-control"
                style=" font-family: 'Roboto', sans-serif;font-size: 10px;color:black;">
            </div>
            <div class="mb-3">
              <label for="">Link File</label>
              <input type="text" required placeholder="link File" name="link" data-original-title="" title="" class="form-control"
                style=" font-family: 'Roboto', sans-serif;font-size: 10px;color:black;">
            </div>
            <div class="mb-3">
