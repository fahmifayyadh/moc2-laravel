...
<div class="container-fluid" id="container-wrapper">
    ...
    <a href="allproduct.html">
        ...
        Kelola File {{ $course->name }} <span style="font-weight: 100;"></span>
        </p>
    </a>
    </div>
    ...
    <div class="col-12" style="top: -3vh;">
        <div class="tambah" style="float: right;">
            <a href="{{route('file.create', $course->id)}}" class="btn btn-5">Tambah File</a>
        </div>
    </div>
    <!-- <div class="col-lg-12"> -->
    <div class="col-12 col-md-12 col-lg-12" style="margin-top: 5vh;">
        ...
        <table id="table_id" class="display table table-dark" style="background: #252633;">
            <thead>
            <th class="th-1">No</th>
            <th class="th-1">Nama File</th>
            <th class="th-1">Action</th>
            <!-- <th class="th-2"></th> -->
            </thead>
            <tbody>
            ...
            <tr>
                ...
                <td>
                <a target="__blank" href="{{$ce->link}}" class="btn btn-4" role="button">Lihat</a>
                <a href="{{route('file.edit',$ce->id)}}" class="btn btn-5" role="button">Edit</a>
