        ...
        <div class="col-12 col-md-6 col-lg-12">
          <form action="{{route('course.paketCreate')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <input placeholder="Harga" name="price" value="{{old('price')}}" class="form-control numberformat"
                style=" font-family: 'Roboto', sans-serif;font-size: 10px;color:black;">
                @error('price')
                <small>{{$message}}</small>
                @enderror
            ...
            <div class="mb-3">
              ...
              <input class="form-control numberformat" placeholder="Point Pembeli" name="point_pembeli" value="{{old('point') ?? 0}}" style=" font-family: 'Roboto', sans-serif;font-size: 10px;color:black;" >
                @error('point_pembeli')
                <small>{{$message}}</small>
                @enderror
            </div>
            <div class="mb-3">
              ...
              <input class="form-control numberformat" placeholder="Point Sponsor" name="point_sponsor" value="{{old('point') ?? 0}}" style=" font-family: 'Roboto', sans-serif;font-size: 10px;color:black;" >
                @error('point_sponsor')
                <small>{{$message}}</small>
                @enderror
            </div>
            <div class="mb-3">
              ...
              <input class="form-control numberformat" placeholder="Komisi" name="commission" value="{{old('commission') ?? 0}}" style=" font-family: 'Roboto', sans-serif;font-size: 10px;color:black;" >
                @error('commission')
                <small>{{$message}}</small>
                @enderror
            </div>
            <div class="mb-3">
              ...
              <div id="summernote" class="form-control summernote" name="desc" value="{{old('desc')}}">Paket Detail</div>
                @error('desc')
                <small>{{$message}}</small>
                @enderror
            </div>
