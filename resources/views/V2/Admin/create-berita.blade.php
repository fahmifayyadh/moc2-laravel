    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <a href="allproduct.html"  >
        <p style="color:white;font-family: 'Rubik', sans-serif; font-weight: 600; font-size: 30px;">
          ...
          CREATE BERITA <span style="font-weight: 100;"></span>
        </p>
      </a>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-12">
            <div class="mb-3">
              ...
              <input type="text" required placeholder="Judul" name="judul" value="{{old('judul')}}" class="form-control"
             ...
             <div class="mb-3">
              ...
              <input class="form-control" required type="text" placeholder="deskripsi singkat" name="deskripsi" value="{{old('deskripsi')}}"
                style=" font-family: 'Roboto', sans-serif;font-size: 10px;color:black;">
                @error('deskripsi')
                <small>{{$message}}</small>
                @enderror
            ...
            <div class="mb-3">
              ...
              <div class="col-md-8">
                <input class="form-control" type="file" name="img" value="{{old('img')}}" required>
              </div>
              @error('img')
              <small>{{$message}}</small>
              @enderror
    ...
    <div class="container container-3">
      ...
      <div class="row">
            <div class="col-12">
              ...
              <textarea class="form-control summernote" required placeholder="Isi Berita"name="isi" id="" cols="30" rows="10">{{old('isi')}}</textarea>
                @error('isi')
                <small>{{$message}}</small>
                @enderror
            </div>
