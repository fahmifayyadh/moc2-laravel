              ...
              <div class="modal-body">
                <div class="mb-3">
                  <select class="form-control" name="product" id="filter-produk" onchange="location = this.value;">
                    ...
                    <option value="{{route('transaksi.order-fisik-filter','selesai')}}">Selesai</option>
                    <option value="{{route('transaksi.order-fisik-filter','pembayaran')}}">Menunggu Pembayaran</option>
                    <option value="{{route('transaksi.order-fisik-filter','batal')}}">Batal</option>
                  </select>
                </div>
              </div>
          </div>
