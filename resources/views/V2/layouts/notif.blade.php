        ...
        <div class="modal-content" style="border-radius: 20px; background: #283246;">
            ...
            <div class="modal-body">
                        ...
                        <td>{{$n->created_at->diffForHumans()}}</td>
                            <td>
                                ...
                                <a href="{{route('notif.baca',$n->id)}}">
                                    <button class="btn" style="background: #FF9F1C; border-radius: 7px; font-weight: bold; color: black;">Baca</button>
                                </a> 
                                @endif
                            </td>
                        </tr>
                ...
                <div class="modal-footer ">
                  <button class="btn" data-dismiss="modal" aria-label="Close" style="background: black; border-radius: 7px; color: white;">Cancel</button>
                </div>
            </div>
        </div>
    </div>
