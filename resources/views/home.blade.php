          ...
          <div class="container">
            <div class="row">
              ...
              <div class="card-shadow">
                <div>
                  <img src="https://masteronlinecommunity.com/wp-content/uploads/2021/04/Banner-15-1280x632.png" class="img-fluid" alt="Responsive image">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row justify-content-center" >
              <div class="col-sm-12">
                <div> 
                  ...
                  <h1 class="text-center">
                    <span style="text-decoration: line-through; color:red;">Rp 500.000</span>
                  </h1>
                   <h2 class="text-center">
                    Khusus Hari Ini Promo Menjadi
                  </h2>
                  <div class="text-center">
                    <img src="https://masteronlinecommunity.com/wp-content/uploads/2021/03/moc-web-min-1.png" class="img-fluid" alt="Responsive image">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="text-center" id="order">
                  <button type="button" class="btn btn-danger btn-lg" ><a href="https://mocmembership.com/order-sponsor/1/a3yGe5" class="text-white">DAFTARKAN PROMO SAYA SEKARANG</a></button>
                </div>
              </div>
              <div style="padding:2%">
