                            ...
                            <div class="col-sm-6">
                              <div class="media">
                                ...
                                <div class="media-body m-l-20">
                                  <h4 class="media-heading">Batalkan Pencairan</h4>
                                </div>
                              </div>
                              <!-- End Info-->
                            </div>
                          ...
                          <table class="table table-bordered table-striped">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="Promo">
                                      <h5 class="p-2 mb-0">Transaksi</h5>
                                    </td>
                                  </td>
                                  <td class="Penjual">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="itemtext date">transaksi 1</p>
                                    </td>
                                    <td>
                                        <p class="itemtext digits">100000</p>
                                    </td>
                                    <td>
                                        <p class="itemtext digits">123456789</p>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-pill badge-danger" style="color: white;font-size:12px">Prosess</span>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#Modalbeli">Cancel</button>
                                    </td>
                                </tr>
