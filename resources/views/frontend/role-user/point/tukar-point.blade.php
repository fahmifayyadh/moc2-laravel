                            ...
                            <div class="col-sm-6">
                              <div class="media">
                                ...
                                <div class="media-body m-l-20">
                                  <h4 class="media-heading">Tukar Point</h4>
                                </div>
                              </div>
                              <!-- End Info-->
                            </div>
                          ...
                          <table class="table table-bordered table-striped">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#afi0">Detail</button>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <span class="badge badge-pill badge-danger" style="color: white;font-size:12px">nonaktif</span>
                                    </td>
                                    <td>
