                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group row">
                                    <select class="form-control selectpicker" id="search-produk"  data-size="5" data-live-search="true">
                                      ...
                                      <option data-tokens="skinc1are">skincare</option>
                                  ...
                                  <div class="form-group row">
                                    <select class="form-control field" data-size="5" data-type="select" id="inputsize">
                                      ...
                                      <option value="col-md-1">Dibatalkan </option>
                                      <option value="col-md-1">Selesai </option>
                                    </select>
                                </div>
                                </div>
                          ...
                          <table class="table table-bordered table-striped">
                            <tbody>
                              <tr>
                                ...
                                <td class="Afiliasi">
                                    <h5 class="p-2 mb-0">Tanggal Masuk member</h5>
                                  </td>
                                <td class="Komisi">
                              ...
                              <tr>
                                ...
                                <td>
                                  <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#komisi-konfirmasi">Konfirmasi</button>
                            ...
                            <tr>
                              ...
                              <td>
                                <span class="badge badge-pill badge-info" style="color: white;font-size:12px">Selasai</span>
                              </td>
                              <td>
                                {{-- <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#komisi-konfirmasi">Konfirmasi</button> --}}
                            ...
                            <tr>
                                ...
                                <td>20-10-2020</td>
                                <td>
                                  <p class="itemtext digits">Rp 3.000.000</p>
                                </td>
                                <td>
