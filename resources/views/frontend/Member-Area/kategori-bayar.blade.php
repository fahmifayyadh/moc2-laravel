        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>10 November 2020</td>
              <td>20000</td>
              <td><span class="badge badge-pill badge-danger" style="color: white;font-size:12px">Pesanan Dibatalkan</span></td>
              <td>
                  <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#preview-pembayaran">Detail</button>
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#ProsesModal2">Beli Lagi</button>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form class="theme-form">
                    ...
                    <div class="form-group">
                      <select class="form-control digits" id="exampleFormControlSelect9" >
                        <option value="" disabled selected>User/Member</option>
                        <option>User</option>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="theme-form">
                  ...
                  <div class="form-group">
                    <input class="form-control" type="text" placeholder="Input Resi">
                  </div>
                  <!-- <div class="form-group">
                  <input class="form-control" type="text" placeholder="Nama Pemilik">
                </div> -->
