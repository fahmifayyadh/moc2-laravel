                        ...
                        <div class="table-responsive invoice-table" id="table">
                          <table class="table table-bordered table-striped">
                            ...
                            <tr>
                              ...
                              {{-- <td>
                                <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#afi0{{$i}}">Detail</button>
                                <div class="modal fade" id="afi0{{$i}}" tabindex="-1" role="dialog" aria-labelledby="afi0" aria-hidden="true">
