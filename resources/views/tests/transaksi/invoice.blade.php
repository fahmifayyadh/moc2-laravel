              ...
              <div class="invoice">
                <div id="printJS-form">
                  <div>
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        Batas Waktu Pembayaran: <span class="digits">{{\Carbon\Carbon::now()->addDays(1)}}</span></p>
                        </div>
                        <!-- End Title-->
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-5">
                      <div class="media">
                        <div class="media-left"><img class="media-object rounded-circle img-60" src="{{asset('/assets/images/logo/logo.png')}}" alt=""></div>
                        <div class="media-body m-l-20">
                          <h4 class="media-heading">{{$d->name}}</h4>
                        <p>{{$d->alamat}} <br> <span class="digits">{{$d->no_hp}}</span></p>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-7">
                      ...
                      <h6>{{$b->name}}</h6>
                      <label>A.n - {{$b->nama_pemilik}}</label>
                        <p>No. reg - {{$b->no_rekening}}</p>
                      </div>
                    </div>
                  </div>
                  <!-- End Invoice Mid-->
                      ...
                      <table class="table table-bordered table-striped">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <p class="m-0">{!!$t->product->desc!!}</p>
                            </td>
                            <td>
                            <p class="itemtext digits">{{$t->kuantiti}}</p>
                            </td>
                            <td>
                            ...
                            <td>
                            <p class="itemtext digits">Rp.{{$d->ongkir}}</p>
                            </td>
                            <td>
                            <p class="itemtext digits">Rp.{{($t->kuantiti*$t->price)+$d->ongkir-$t->discount}}</p>
                            </td>
                          </tr>
                          <tr>
                            <td></td>
                            ...
                            <h6 class="mb-0 p-2">Rp.{{($t->kuantiti*$t->price)+$d->ongkir-$t->discount}}</h6>
                            </td>
                          </tr>
                        </tbody>
                      </table>
