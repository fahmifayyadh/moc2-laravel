              ...
              <div class="card">
                ...
                @csrf
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" name="amount" id="inputNumber" type="number" placeholder="Masukan Nominal" aria-describedby="inputGroupPrepend" required="">
                  </div>
                  <br>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="no_rekening" class="form-control" id="rek" placeholder="Masukan Nomer Rekening">
                  </div>
                  <div class="form-group">
                    <label for="rek">A.N No Rekening:</label>
                    <input type="text" name="name" class="form-control" id="rek" placeholder="Masukan Nama Pemilik Nomer Rekening">
                  </div>
                </form>
                </div>
