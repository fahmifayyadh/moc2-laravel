    ...
    <div class="modal-header">
      ...
      <div class="modal-body">
        <div class="form-group">
            <label for="">Barang yang promosikan</label>
        <input class="form-control" type="text" placeholder="{{$i->paket->name}}" readonly>
        </div>
        <div class="form-group">
            <label for="">Harga Barang</label>
        <input class="form-control" type="text/" placeholder="{{$i->paket->price}}" readonly>
        </div>
        <div class="form-group">
