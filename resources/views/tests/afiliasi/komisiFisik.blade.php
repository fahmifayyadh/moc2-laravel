                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body m-l-20">
                                                                    <h4 class="media-heading">komisi Fisik</h4>
                                                                </div>
                                                            </div>
                                                            <!-- End Info-->
                                                        </div>
                                                        ...
                                                        <table class="table table-bordered table-striped">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{$t->user->name}}</td>
                                                                    <td>
                                                                        <p class="itemtext date">{{$t->product->name}}</p>
                                                                    </td>
                                                                    <td><p class="itemtext poin">
                                                                      {{$t->point_sponsor}}
                                                                      </p> </td>
                                                                    ...
                                                                    <td><span class="badge badge-pill badge-info"
                                                                            ...
                                                                            Konfirmasi</span></td>
                                                                            @elseif(!is_null($t->komisiFisik) && $t->komisiFisik->status ==
                                                                            'batal')
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        @include('tests.afiliasi.komponenKomisiFisik.konfrim')
                                                                        @endif
                                                                    </td>
