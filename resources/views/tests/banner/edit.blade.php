@extends('layouts.master',['title'=>'Edit Banner'])
@section('head')
        ...
        <div class="tab-content" id="top-tabContent">
          <div class="tab-pane fade show active" id="top-home" role="tabpanel" aria-labelledby="top-home-tab">
            <div class="row">
              ...
              <!-- </div> -->
              <div class="col-sm-12 ">
            	<form class="theme-form" action="{{route('banner.edit',$banner->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
...
@enderror
        ...
        <img style="width: 25%;height:150px" src="{{ asset(Storage::url('banner/'.$banner->img))}}" alt="">
        <div class="form-group">
