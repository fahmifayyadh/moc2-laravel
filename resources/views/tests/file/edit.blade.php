              ...
              <div class="tab-pane fade show active" id="top-home" role="tabpanel" aria-labelledby="top-home-tab">
                <div class="row">
                  ...
                  <div class="col-sm-12 ">
                    ...
                    <input class="form-control" required value="{{$file->nama}}" id="exampleInputEmail1" type="text" placeholder="Nama File" name="nama" data-original-title="" title="">
                    </div>
                    <div class="form-group">
                    <input class="form-control" required id="exampleInputEmail1" value="{{$file->link}}" type="text" placeholder="link File" name="link" data-original-title="" title="">
                    </div>
                    <div class="form-group">
